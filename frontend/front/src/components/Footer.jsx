  ...
  return (
    <footer className='bg-slate-900 shadow-md'>
        ...
        <div className='container mx-auto px-4'>
          <div className='grid grid-cols-1 md:grid-cols-3 gap-12 w-full'>
            ...
            <div className='md:text-center'>
              <h2 className='text-lg font-bold mb-6 border-b border-gray-700 pb-2 inline-block'>{t("pages")}</h2>
              <ul className='space-y-3 text-gray-400'>
                <li><Link to="/" className='hover:text-white transition-colors'>{t("home")}</Link></li>
                <li><Link to="/a-propos" className='hover:text-white transition-colors'>{t("about")}</Link></li>
                <li><Link to="/faqs" className='hover:text-white transition-colors'>{t("faqs")}</Link></li>
            ...
            <div className='md:text-right flex flex-col md:items-end'>
              <h2 className='text-lg font-bold mb-6 border-b border-gray-700 pb-2 inline-block'>{t("contact")}</h2>
              ...
              <p className='text-xs text-gray-500 mt-2 italic'>{t("service")}</p>
            </div>
      ...
      <div className='container mx-auto text-center py-6 text-gray-500 text-sm border-t border-slate-800'>
        <p>
          &copy; {new Date().getFullYear()} Muriel Luxury Beauty. {t("rights")}
        </p>
      </div>
    </footer>
  );
